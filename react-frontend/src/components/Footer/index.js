        ...
        <>
            <footer id="react-footer" className={footerClass ? footerClass : 'react-footer home-main'}>
                        ...
                        <div className="row">
                            <div className="col-lg-3 md-mb-30">
                                <div className="footer-widget footer-widget-1">
                                    ...
                                    <h5 className="footer-subtitle">Best place to share your skills <br/>
                                    and learn new skills<br/> within a popular community</h5>
                                    <ul className="footer-address">
                                        ...
                                        <li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg><a href="mailto:info@yourdmain.com"> info@Skillfy.com </a></li>
                                    </ul>                               
                                </div>
                            </div>
                            <div className="col-lg-3 md-mb-30">
                            ...
                            <div className="col-lg-3">
                                <div className="footer-widget footer-widget-4">
                                    ...
                                    <div className="footer3__form">
                                        <p>Get the latest Skillfy news <br />delivered to you inbox</p>
                                        <form action="#">
                ...
                <div className="copyright">  
                    <div className="container">                  
                        <div className="react-copy-left">© 2025 <Link to="/">Skillfy.</Link> All Rights Reserved</div>
