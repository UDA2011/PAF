...
import SingleCourseFour from '../../components/Skill/SingleCourseFour';
                    ...
                    <div className="col-md-6">
                        <div className="all__icons">
                            {loading ? (
                                ...
                                <div className="result-count">We found {filteredPosts.length} Skill Posts available for you</div>
                            )}
                        </div>
                    </div>
                        ...
                        <div className="row">
                            {currentPosts.length > 0 ? (
                                ...
                                <div className="col-12 text-center py-5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-alert-circle mb-3">
