                ...
                <div className="row">
                    ...
                    <div className="col-lg-8">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-alert-circle mb-3">
                            ...
                            <p>{searchTerm ? `No results found for "${searchTerm}". Try a different search.` : 'No skill posts are currently available. Help us by contributing!'}</p>
                        </div>
                            </div>
                            </div>
                    ) : (
                                        ...
                                        <div className="blog-content">
                                            <ul className="top-part">
                                                <li>
                                                    ...
                                                    <img style={{ width: 36, height: 36, borderRadius: "50%" }} src={data.authorImg} alt={data.authorName} /> 
                                                    </Link>
                                                    {data.authorName}
                                ...
                                {searchTerm && (
                                    <div className="search-info mt-2">
                                        <span>
                                            {filteredPlans.length === 0 
                                                ? "No results found" 
                                                : `Found ${filteredPlans.length} result${filteredPlans.length !== 1 ? 's' : ''}`}
                                            {searchTerm && ` for "${searchTerm}"`}
                                            {searchTerm && (
                                                <button 
                                                    onClick={() => setSearchTerm('')}
                                                    className="clear-search-btn ml-2"
                                                    style={{
