                    ...
                    <div className="row">
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            <div className="hero4__content">
                                <h1 className="hero4__title wow animate__fadeInUp" data-wow-duration="0.3s">Unlock skills that matter</h1>
                                <p className="hero4__paragraph wow animate__fadeInUp" data-wow-duration="0.5s">learn online, at your own pace, wherever you are.</p>                                    
                                <div className="event__video-btn--plays">
                                    <Link to="/skill-feed" className="hero4-btn wow animate__fadeInUp" data-wow-duration="0.7s">Get Started</Link>
